...
public class SubjectController {
    ...
    public ResponseEntity<ApiResponse<SubjectResponse>> updateSubject(
            @PathVariable @Positive(message = "ID môn học phải lớn hơn 0") Long id,
    ...
    public ResponseEntity<ApiResponse<List<SubjectResponse>>> getSubjectsBySemesterId(
            @PathVariable @Positive(message = "ID học kỳ phải lớn hơn 0") Long semesterId) {
