...
import com.example.exe101_bioverse.mapper.AnswerImageMapper;
import com.example.exe101_bioverse.repository.AnswerImageRepository;
...
//        }
    ...
    @Override
    public List<AnswerImageResponse> getAnswerImagesByQuestionId(Long questionId) {
        return answerImageRepository.findByQuestionId(questionId).stream()
